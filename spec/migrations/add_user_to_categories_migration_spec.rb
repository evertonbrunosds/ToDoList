# spec/migrations/add_user_to_categories_migration_spec.rb

require 'rails_helper'
require 'rails/generators/test_case'
require 'generators/add_user_to_categories/add_user_to_categories_generator'

describe AddUserToCategoriesGenerator, type: :generator do
  let(:migration_name) { 'AddUserToCategories' }
